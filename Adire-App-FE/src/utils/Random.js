...
// const handleButtonClick = () => {
  ...
  //     components.push(<input type="file" name="" id="" onChange={handleFileChange} key={i} />);
  //   }
  //   return components;
  // };
  ...
  // const renderImages = () => {
  //   const images = [];
  //   images = selectedFile.map((file) => {
  //     return <img src={file} alt="Selected file" style={{ maxWidth: '100%' }} />;
  //   });
  //   return images;
  // };
...
//     const components = [];
//     for (let i = 0; i < count; i++) {
//       components.push(<ComponentToRender key={i} />);
//     }
//     return components;
//   };
...
// https://res.cloudinary.com/dlvzbmq1o/image/upload/v1681856256/cynzwxyjc2l1511tsyeg.jpg
